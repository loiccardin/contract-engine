...
- **Depend de :** `googleapis` (npm), `stream` (Readable), `process.env.GOOGLE_DRIVE_ROOT_FOLDER_ID`, `process.env.GOOGLE_DRIVE_ARCHIVE_FOLDER_ID` (promesses), `process.env.GOOGLE_DRIVE_CONTRATS_ROOT_FOLDER_ID`, `process.env.GOOGLE_DRIVE_CONTRATS_ARCHIVE_FOLDER_ID` (contrats)
